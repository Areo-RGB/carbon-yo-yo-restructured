...
The URL is served from APK assets using AndroidX `WebViewAssetLoader`. File/content access remains disabled. Yo-Yo IR1, Yo-Yo IR2 and Beep Test protocol audio are bundled in the APK, so the app does not need network access for playback.
